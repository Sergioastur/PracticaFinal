...
$stmt->bind_param("ssssi", $fecha, $hora, $tipo_comida, $glucosa, $usuario);
...
if ($row["total"] == 0) {
    echo "<p>No se encontró la comida</p> <br> <a href='../../index.html'>Volver al inicio</a> <a href='../ui/crearHiper.php'>Volver a intentarlo</a>";
    exit();
} else {
